import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@pancakeswap-libs/sdk'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(QUICK) ? undefined : wrapped, chainId === ChainId.MAINNET ? QUICK : undefined],
      ...
      [chainId ? QUICK : undefined, chainId === ChainId.MAINNET ? USDC : undefined]
    ],
