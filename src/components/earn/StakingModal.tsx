    ...
    <Modal isOpen={isOpen} onDismiss={wrappedOnDismiss} maxHeight={90}>
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          <RowBetween>
            <TypeBody.mediumHeader>Deposit</TypeBody.mediumHeader>
          ...
          <HypotheticalRewardRate dim={!hypotheticalRewardRate.greaterThan('0')}>
            <div>
              <TypeBody.black fontWeight={600}>Daily Rewards</TypeBody.black>
            </div>
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOnDismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            <TypeBody.largeHeader>Depositing Liquidity</TypeBody.largeHeader>
            <TypeBody.body fontSize={20}>{parsedAmount?.toSignificant(4)} QUICK-V2</TypeBody.body>
          </AutoColumn>
        </LoadingView>
      )}
      {attempting && hash && (
        <SubmittedView onDismiss={wrappedOnDismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TypeBody.body fontSize={20}>Deposited {parsedAmount?.toSignificant(4)} QUICK-V2</TypeBody.body>
          </AutoColumn>
        </SubmittedView>
      )}
    </Modal>
