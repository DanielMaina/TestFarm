...
import { useVeryOldStakingInfo } from '../../state/stake/hooks'
...
export default function ManageOld({
  match: {
  ...
  const oldStakingInfos = useVeryOldStakingInfo(stakingTokenPair);
  const stakingInfos = oldStakingInfos;
